...
export const Navbar = () => {
    ...
    return (
        ...
        //     <Logo />
        // </nav>
        <nav className={cn("z-50 bg-background dark:bg-[#1F1F1F] fixed top-0 flex items-center w-full p-6 transition-all", scrolled && "border-b border-neutral-200 dark:border-neutral-800 shadow-sm dark:shadow-neutral-200/10 ")}>
            <Logo />
